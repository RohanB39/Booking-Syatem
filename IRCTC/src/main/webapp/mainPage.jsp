...
<body>
	...
	<div class="main-body">
		<div class="headings">Do More With Booking.com</div>
		<div class="con">
			<div class="con-body">
				<div class="con-status">
					<i class="material-icons" style="color: #1e88e5;">flight</i> <a
						href="flightStatus.jsp">Flight Status</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #ff7043;">train</i> <a
						href="trainStatus.jsp">Train Status</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #66bb6a;">directions_bus</i>
					<a href="busStatus.jsp">Bus Status</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #ffa726;">local_taxi</i> <a
						href="flightStatus.jsp">Airport Cabs</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #29b6f6;">map</i> <a
						href="flightStatus.jsp">Plan</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #ab47bc;">directions_car</i>
					<a href="flightStatus.jsp">Car Rental</a>
				</div>
				<div class="vertical-line"></div>

				<div class="con-status">
					<i class="material-icons" style="color: #ef5350;">group</i> <a
						href="flightStatus.jsp">Group Booking</a>
				</div>
			</div>
		</div>
	</div>
	...
	<section id="offers">
		...
		<div class="slider-container">
			<button class="slick-prev">
				<i class="material-icons" style="color: #ef5350;">keyboard_arrow_left</i>
			</button>
	...
	<section id="offers">
		<div class="headings">Why Book With Booking.com</div>
		<div class="slider-container">
			<div class="con-offers1"
				style="display: flex; justify-content: center; align-items: center; width: 100%; z-index: -10;">
				<div class="offers-div1">
					<div class="offers-img1">
						<img alt="01" src="img/w1.webp">
					</div>
				</div>
				<div class="offers-div1">
					<div class="offers-img1">
						<img alt="01" src="img/w2.webp">
					</div>
				</div>
				<div class="offers-div1">
					<div class="offers-img1">
						<img alt="01" src="img/w3.webp">
					</div>
				</div>
				<div class="offers-div1">
					<div class="offers-img1">
						<img alt="01" src="img/w4.webp">
					</div>
				</div>
				<div class="offers-div1">
					<div class="offers-img1">
						<img alt="01" src="img/w5.webp">
					</div>
				</div>
			</div>
		</div>
